        ...
        "questions": [
            ...
            },
            {
                ...
                "options": [
                    ...
                    "A function processing multiple primitive types only",
            ...
            },
            {
                ...
                "options": [
                    "Yes, this is known as Method Overriding",
                    "No, inherited methods are final",
                    "Only in procedural programming",
                    "Yes, but it's called Overloading"
                ],
                "answerIndex": 0
            },
            {
    ...
    },
    {
        ...
        "questions": [
            ...
            },
            {
                ...
                "options": [
                    "Arrays store elements consecutively in memory; Linked lists use pointers",
            ...
            },
            {
                ...
                "options": [
                    "A pointer to the parent and left child",
        ...
        "questions": [
            {
                ...
                "options": [
                    ...
                    "The worst-case theoretical time or space complexity of an algorithm",
            ...
            },
            {
                ...
                "options": [
                    ...
                    "How much memory/RAM an algorithm requires during execution",
            ...
            },
            {
                ...
                "options": [
                    ...
                    "Storing the results of expensive function calls and returning the cached result when the same inputs occur",
    ...
    },
    {
        ...
        "questions": [
            ...
            },
            {
                ...
                "options": [
                    "A key to encrypt the database",
                    "A unique identifier for a record in a table",
                    "The first column in any database",
            ...
            },
            {
                ...
                "options": [
                    "Making all table names lowercase",
            ...
            },
            {
                ...
                "options": [
                    "A key used by external software",
    ...
    },
    {
        ...
        "questions": [
            ...
            },
            {
                ...
                "options": [
                    "Duplicates a branch locally",
                    "Creates a backup of local files",
                    "Copies an existing Git repository from a remote server to a local machine",
            ...
            },
            {
                ...
                "options": [
                    ...
                    "A snapshot of the project's files at a given point in time",
                    "Closing a branch"
                ],
                "answerIndex": 2
            },
            {
                ...
                "options": [
                    ...
                    "Downloads remote commits to your local machine",
                    "Forcefully merges two branches",
            ...
            },
            {
                ...
                "options": [
                    "Downloads commits from remote but doesn't merge them",
            ...
            },
            {
                ...
                "options": [
                    ...
                    "To create a secure login for developers",
                    "To isolate experimental or feature work from the main codebase",
                    "To deploy to AWS"
                ],
                "answerIndex": 2
            },
            {
                ...
                "options": [
                    "Git automatically deletes one file",
                    "GitHub locks your account",
                    "Git stops the merge because there are competing changes that it cannot resolve automatically",
                    "The Internet connection to the remote repo is lost"
                ],
                "answerIndex": 2
            },
            {
                ...
                "options": [
                    "A request to download the codebase",
                    "A request asking the repo owner to review and merge your changes into their branch",
                    "An error report",
                    "A command line Git tool"
                ],
                "answerIndex": 1
            }
        ]
        ...
        "questions": [
            {
                ...
                "options": [
                    ...
                    "Standard Data Language Compiler",
                    "Software Distribution Life Cycle"
                ],
                "answerIndex": 1
            },
            {
            ...
            },
            {
                ...
                "options": [
                    "A linear, sequential approach to software design",
                    "An iterative and incremental approach favoring flexibility and collaboration",
                    "Writing all code before designing",
                    "Hiring fast developers"
                ],
                "answerIndex": 1
            },
            {
                ...
                "options": [
                    ...
                    "A set period (e.g., 2 weeks) during which specific work has to be completed and made ready for review",
                    "A daily meeting",
            ...
            },
            {
                ...
                "options": [
                    ...
                    "Ensuring code is readable, understandable, and maintainable by humans",
                    "Using the newest syntax"
                ],
                "answerIndex": 2
            },
            {
                ...
                "options": [
                    "Writing bug reports",
                    "Process of finding and resolving defects or problems within a program",
                    "Deploying software to a server",
                    "Testing UX features"
                ],
                "answerIndex": 1
            },
            {
                ...
                "options": [
                    "A brand of databases",
                    "Principles for object-oriented design intended to make software more understandable, flexible, and maintainable",
                    "Security, Optimization, Logging, Integration, Deployment",
                    "Standard Operational Logic Integration Design"
                ],
                "answerIndex": 1
            },
            {
                ...
                "options": [
                    "Paying for AWS servers",
                    "Taking shortcuts in code implementation that will cost more effort to fix/maintain later",
                    "Failing to pay developer salaries",
            ...
            },
            {
                ...
                "options": [
                    "Merging all developer working copies to a shared mainline several times a day with automated testing",
                    "Continuously talking to customers",
                    "Writing code without taking breaks",
                    "Leaving bugs in the code on purpose"
                ],
                "answerIndex": 0
            }
        ]
        ...
        "questions": [
            ...
            },
            {
                ...
                "options": [
                    ...
                    "Request Execution Standard Tool",
                    "Response Event System Transfer"
                ],
                "answerIndex": 1
            },
            {
            ...
            },
            {
                ...
                "options": [
                    "To style the webpage using CSS",
                    "To run browser animations",
                    "To handle business logic, process data, and securely interact with databases",
                    "To display images"
                ],
                "answerIndex": 2
            }
    ...
    },
    {
        ...
        "questions": [
            ...
            },
            {
                ...
                "options": [
                    "Adding more individual servers to a pool",
                    "Adding more power (CPU, RAM) to an existing machine",
                    "Opening new data centers",
            ...
            },
            {
                ...
                "options": [
                    "To balance the electrical load of the server room",
            ...
            },
            {
                ...
                "options": [
                    "A database type",
                    "A system where all components are tightly coupled and run as a single unified application",
                    "A highly distributed AI system",
            ...
            },
            {
                ...
                "options": [
                    "Developing on very small computers",
                    "A monolithic app with tiny functions",
                    "Structuring an application as a collection of loosely coupled, independently deployable services",
                    "A single massive server handling everything"
                ],
                "answerIndex": 2
            },
            {
                ...
                "options": [
                    "Paying for APIs",
                    "Storing copies of frequently accessed data in a fast-access storage layer to speed up retrieval",
                    "Deleting old data",
            ...
            },
            {
                ...
                "options": [
                    "A television network for developers",
                    "A distributed group of servers delivering web content based on the geographic locations of the user",
            ...
            },
            {
                ...
                "options": [
                    "Deleting tables",
                    "Horizontal partitioning of a database to split large tables across multiple servers",
                    "Indexing columns",
            ...
            },
            {
                ...
                "options": [
                    "Developers are always online",
                    "A system operating continuously without failing for a designated period",
                    "Software that costs a lot of money",
                    "A database that responds in 1ms"
                ],
                "answerIndex": 1
            }
        ]
        ...
        "questions": [
            {
                ...
                "options": [
                    ...
                    "Clarify the problem, think out loud, come up with an approach, write code, then test it",
            ...
            },
            {
                ...
                "options": [
                    "Start, Tell, Answer, Review",
                    "Strategy, Timing, Action, Result",
                    "Situation, Task, Action, Result",
                    "Situation, Technique, Approach, Reply"
                ],
                "answerIndex": 2
            },
            {
                ...
                "options": [
                    "To test how fast you code",
                    "To see if you know syntax",
                    "To understand your past behavior, communication skills, and cultural fit",
                    "To ask you to balance a load balancer"
                ],
                "answerIndex": 2
            },
            {
                ...
                "options": [
                    "The most optimized, linear time solution",
                    "A solution that heavily relies on caching",
                    "A straightforward but usually slow solution that checks all possible candidates",
            ...
            },
            {
                ...
                "options": [
                    "To waste time",
                    "To see if you understand the efficiency and scalability of your solution",
                    "To see if you can do complex calculus",
                    "To check how many lines of code you wrote"
                ],
                "answerIndex": 1
            },
            {
                ...
                "options": [
                    ...
                    "Communicate your thought process and ask for hints or clarify constraints",
            ...
            },
            {
                ...
                "options": [
                    ...
                    "Solving a problem by writing code/diagrams on a whiteboard without an IDE",
                    "Designing a UI using white space",
                    "Writing tests first"
                ],
                "answerIndex": 1
            },
            {
                ...
                "options": [
                    ...
                    "Arrays and Loops",
                    "In-depth distributed System Design",
            ...
            },
            {
                ...
                "options": [
                    "Ignore them",
                    "Write a completely separate app",
                    "Identify them early during the clarify stage and write unit tests for them at the end",
                    "Tell the interviewer edge cases don't matter"
                ],
                "answerIndex": 2
            },
            {
                ...
                "options": [
                    "Gather requirements (functional and non-functional) and clarify scale/constraints",
                    "Draw a load balancer",
                    "Write SQL schemas",
                    "Choose between AWS and GCP instantly"
                ],
                "answerIndex": 0
            }
        ]
