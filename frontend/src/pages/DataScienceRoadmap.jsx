        ...
        "questions": [
            ...
            },
            {
                ...
                "options": [
                    ...
                    "The probability of observing the test results given that the null hypothesis is true",
        ...
        "questions": [
            ...
            },
            {
                ...
                "options": [
                    ...
                    "It uses 3D hardware acceleration",
                    "It provides beautiful default styles and high-level interfaces for statistical graphics",
                    "It can write data directly to databases"
                ],
                "answerIndex": 2
            },
            {
            ...
            },
            {
                ...
                "options": [
                    ...
                    "Visualizing a correlation matrix or 2D density",
                    "Plotting time series forecasting"
                ],
                "answerIndex": 2
            }
        ]
        ...
        "questions": [
            {
                ...
                "options": [
                    ...
                    "To convert categorical data into a binary matrix format suitable for ML algorithms",
                    "To encrypt sensitive data",
                    "To normalize numerical data to a 0-1 scale"
                ],
                "answerIndex": 1
            },
            {
                ...
                "options": [
                    ...
                    "Filling in missing data with estimated values (like mean or median)",
                    "Detecting outliers",
                    "Scaling features"
                ],
                "answerIndex": 1
            },
            {
                ...
                "options": [
                    "Increasing the number of features using polynomial expansion",
                    "Standardizing or normalizing the range of independent variables or features",
            ...
            },
            {
                ...
                "options": [
                    ...
                    "A categorical variable that cannot be encoded",
                    "A duplicate record"
                ],
                "answerIndex": 1
            },
            {
                ...
                "options": [
                    ...
                    "Algorithms based on distance metrics perform poorly if features have vastly different scales",
                    "It removes missing values automatically",
                    "It prevents overfitting by reducing dimensions"
                ],
                "answerIndex": 1
            },
            {
                ...
                "options": [
                    ...
                    "Assigning a unique integer to each category label",
                    "Labeling outliers dynamically",
                    "Removing all labels from a DataFrame"
                ],
                "answerIndex": 1
            },
            {
                ...
                "options": [
                    ...
                    "ML algorithms might misinterpret the integer values as having a mathematical order/hierarchy",
                    "It cannot assign Negative numbers"
                ],
                "answerIndex": 2
            },
            {
                ...
                "options": [
                    ...
                    "Dimensionality reduction while keeping most of the variance",
        ...
        "questions": [
            {
                ...
                "options": [
                    ...
                    "Training a model on labeled data mapping inputs to known outputs",
                    "Clustering data based on hidden patterns without labels",
                    "Learning via reward/punishment feedback"
                ],
                "answerIndex": 1
            },
            {
            ...
            },
            {
                ...
                "options": [
                    ...
                    "Because databases can't hold all the data",
                    "To train two different models simultaneously"
                ],
                "answerIndex": 1
            },
            {
                ...
                "options": [
                    "When a model learns the training data too well, capturing noise, but performs poorly on test data",
                    "When a model is too simple to capture underlying patterns",
                    "When training data is too large for memory",
                    "When the model correctly fits the test data perfectly"
                ],
                "answerIndex": 0
            },
            {
                ...
                "options": [
                    "When the model performs perfectly on training data",
                    "When a model is too simple to learn the underlying patterns in the training data",
                    "When test data has fewer features than training data",
                    "When there is overfitting but on a smaller scale"
                ],
                "answerIndex": 1
            },
            {
            ...
            },
            {
                ...
                "options": [
                    ...
                    "Training an agent to make decisions by rewarding desired behaviors and punishing undesired ones",
            ...
            },
            {
                ...
                "options": [
                    ...
                    "Classifying images of dogs vs cats",
                    "Clustering users by demographics",
                    "Identifying credit card fraud (Yes/No)"
                ],
                "answerIndex": 0
            },
            {
        ...
        "questions": [
            ...
            },
            {
                ...
                "options": [
                    ...
                    "The learning rate",
                    "The number of nearest data points considered to determine the class/value of a new point",
            ...
            },
            {
                ...
                "options": [
                    "An unsupervised clustering algorithm that partitions data into K distinct groups",
                    "A supervised classification algorithm",
                    "A regression strategy for time-series",
            ...
            },
            {
                ...
                "options": [
                    "Hyperplane that best separates classes with maximum margin",
    ...
    },
    {
        ...
        "questions": [
            ...
            },
            {
                ...
                "options": [
                    "How many of the actual positive cases were caught",
            ...
            },
            {
                ...
                "options": [
                    ...
                    "The average time it takes to classify",
            ...
            },
            {
                ...
                "options": [
                    ...
                    "When dealing with highly imbalanced datasets (e.g., 99% Negative, 1% Positive)",
                    "When using Deep Learning",
                    "When dealing with linear regression"
                ],
                "answerIndex": 1
            },
            {
                ...
                "options": [
                    "Validating code syntax across different IDEs",
                    "Splitting data into K subsets, training on K-1, testing on the remaining, and repeating K times",
                    "Validating that data types are correct across columns",
                    "Crossing features together to make new ones"
                ],
                "answerIndex": 1
            },
            {
                ...
                "options": [
                    "Parameters whose values are learned strictly during training (like weights)",
                    "Settings that control the learning process and model architecture picked BEFORE training begins (e.g., learning rate, K in KNN)",
                    "The RAM and CPU of the server",
            ...
            },
            {
                ...
                "options": [
                    "A method for searching SQL databases",
                    "An exhaustive search over specified parameter values for an estimator to find the best hyperparameter combination",
                    "A frontend UI methodology",
                    "A hashing algorithm finding grid coordinates"
                ],
                "answerIndex": 1
            },
            {
                ...
                "options": [
                    ...
                    "A mathematical bug in code",
                    "A matrix of uncleaned text data",
            ...
            },
            {
                ...
                "options": [
                    ...
                    "Recall (minimize missing actual sick cases)",
                    "R-squared metric",
    ...
    },
    {
        ...
        "questions": [
            ...
            },
            {
                ...
                "options": [
                    "Unsupervised Clustering Algorithms (like K-Means)",
                    "Linear Regression",
                    "Decision Trees",
            ...
            },
            {
                ...
                "options": [
                    "Anomaly/Outlier Detection or Binary Classification",
            ...
            },
            {
                ...
                "options": [
                    "The dataset is usually perfectly balanced",
                    "The classes are highly imbalanced (fraud events are very rare compared to normal transactions)",
                    "It requires 3D visualization",
                    "It relies entirely on image data"
                ],
                "answerIndex": 1
            },
            {
            ...
            },
            {
                ...
                "options": [
                    ...
                    "Facial Emotion Recognition or Image Classification",
                    "Analyzing CSV spreadsheets",
                    "Building a REST API"
                ],
                "answerIndex": 1
            },
            {
                ...
                "options": [
                    "Recommends items based on user-to-user similarity",
                    "Recommends items based on item attributes similar to what the user liked before",
                    "Randomly suggests trending content",
                    "Creates new content dynamically using AI"
                ],
                "answerIndex": 1
            },
            {
                ...
                "options": [
                    "Making the model accessible in production (e.g., via a REST API) so others can use it to make predictions",
                    "Deleting the model",
                    "Training the model on local hardware",
                    "Creating visualizations in a notebook"
                ],
                "answerIndex": 0
            }
        ]
        ...
        "questions": [
            {
                ...
                "options": [
                    "Use heavy math and formulas to prove your expertise",
                    "Speak entirely in code syntax",
                    "Use analogies and explain the business impact and simple intuition behind the concept",
            ...
            },
            {
                ...
                "options": [
                    "A multi-hour coding test in C++",
                    "An open-ended business problem where you discuss how you would structure data, choose metrics, and build a solution",
                    "A test on your knowledge of computer hardware",
                    "A typing speed test"
                ],
                "answerIndex": 1
            },
            {
                ...
                "options": [
                    ...
                    "Ranting about how messy the data was for 10 minutes",
                    "Only talking about the final code implementation line-by-line",
                    "Skip it because they already read your resume"
                ],
                "answerIndex": 0
            },
            {
                ...
                "options": [
                    "To test if you know Python",
                    "To assess your problem-solving skills and understanding that imputation methods depend on the data context (e.g. mean vs median vs ML imputation)",
                    "To see if you know how to delete columns",
                    "To trick you into an error"
                ],
                "answerIndex": 1
            },
            {
                ...
                "options": [
                    "The algorithm isn't Deep Learning",
                    "The dataset is highly imbalanced and it's just predicting the majority class",
                    "Your computer is too slow",
                    "Data science doesn't work"
                ],
                "answerIndex": 1
            },
            {
                ...
                "options": [
                    "Testing if code compiles (A or B)",
                    "Statistically determining which of two variants (e.g., website layouts) leads to a better conversion rate/metric",
                    "Testing server speeds in isolated environments",
                    "Teaching two models and keeping the older one"
                ],
                "answerIndex": 1
            },
            {
                ...
                "options": [
                    "High bias causes underfitting (too simple), high variance causes overfitting (captures noise), the goal is a balance.",
                    "Both should always be zero.",
                    "Bias means discrimination, variance means math.",
                    "High variance is always better."
                ],
                "answerIndex": 0
            },
            {
                ...
                "options": [
                    "Memorize all keyword capitalizations",
                    "Write complex queries (JOINs, Window Functions, Subqueries) to extract meaningful insights",
                    "Only write SELECT *",
                    "Use NoSQL databases instead"
                ],
                "answerIndex": 1
            },
            {
                ...
                "options": [
                    "Using standard 'for' loops entirely",
                    "Using apply() or vectorization instead of iterating via completely unoptimized loops, or switching to chunks/Spark for massive data.",
                    "Writing to CSV repeatedly",
            ...
            },
            {
                ...
                "options": [
                    "To become the CEO",
                    "Models have no value unless they solve a real business problem or improve decision-making KPIs",
                    "So they can do accounting alongside programming",
                    "Because statistics tests require it"
                ],
                "answerIndex": 1
            }
        ]
